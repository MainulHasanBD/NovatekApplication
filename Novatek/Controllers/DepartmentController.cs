...
namespace Novatek.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public DepartmentController(NovatekDbContext context, IWebHostEnvironment hostEnv, UserManager<IdentityCustomUser> userManager, SignInManager<IdentityCustomUser> signInManager)
        {
